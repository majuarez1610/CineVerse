...
public class Serie {
    ...
    public Serie(TvShowData datosSerie){
    ...
    public String toString() {
        return String.format("""
                ...
                totalTemporadas,
                actores,
                sinopsis != null && sinopsis.length() > 150 ? sinopsis.substring(0, 150) + "..." : sinopsis,
                poster,
                episodios != null ? episodios.size() : 0
        );
    }
